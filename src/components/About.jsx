  ...
  return (
    ...
    >
        <div className='max-w-screen-lg mx-auto flex flex-col justify-start md:justify-center w-full h-full items-center md:items-end px-10 md:px-0'>
            ...
            <div className='font-2xl text-sm pb-4 w-1/2 ml-auto text-gray-400 flex'>
              I believe in the transformative power of intuitive interfaces, capable of unleashing the full potential of cutting-edge technologies.
            </div>
            <div className='font-2xl text-sm pb-4 w-1/2 ml-auto text-gray-400 flex'>  
            ...
            <div className='font-2xl text-sm pb-4 w-1/2 ml-auto text-gray-400 flex'>  
              I poured hours into hyperoptimizing the tiny device to push beyond its hardware limitations. I taught my parents to use it, opening the channel of online wholesale for my family business. Our profits skyrocketed that year.
            </div>
            <div className='font-2xl text-sm pb-4 w-1/2 ml-auto text-gray-400 flex'>  
            ...
            <div className='font-2xl text-sm pb-4 w-1/2 ml-auto text-gray-400 flex'>  
              Now I forge ahead, blending technology and empathy to shape a future where seamless human-machine harmony prevails.              
            </div>
            <div className='font-2xl text-sm pb-4 w-1/2 ml-auto text-gray-400 flex'>
